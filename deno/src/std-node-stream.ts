...
export class Readable extends Stream {
  ...
  addListener(event: string | symbol, listener: (...args: any[]) => void): this {
    console.log('todo: stream.addListener')
    return this
  }
  ...
  once(event: string | symbol, listener: (...args: any[]) => void): this {
    console.log('todo: stream.once', event)
    return this
  ...
  prependListener(
    ...
    console.log('todo: stream.prependListener')
    return this
  ...
  prependOnceListener(
    ...
    console.log('todo: stream.prependOnceListener')
    return this
  ...
  removeListener(
    ...
    console.log('todo: stream.removeListener')
    return this
  }

  [Symbol.asyncIterator](): AsyncIterableIterator<any> {
    console.log('todo: stream.asyncIterator')
    return false as any
  }
}
